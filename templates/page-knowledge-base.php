        ...
        <div class="eakb-container">
            <div class="eakb-hero-content">
                ...
                <div class="eakb-search-container">
                    <form class="eakb-search-form" role="search" method="get"
                        action="<?php echo esc_url(home_url('/')); ?>">
                        <div class="eakb-search-wrapper">
                            <input type="search" class="eakb-search-input"
                            ...
                            <button type="submit" class="eakb-search-button"
                                aria-label="<?php esc_attr_e('Search', 'energy-alabama-kb'); ?>">
        ...
        <div class="eakb-container">
            ...
            <div class="eakb-category-grid">
                <?php foreach ($categories as $category) : 
                        ...
                        $article_count = wp_count_posts('kb_article')->publish; // We'll improve this later
                        $icon_class = $this->get_category_icon($category->slug);
                    ?>
                <div class="eakb-category-card">
                    <a href="<?php echo esc_url($category_link); ?>" class="eakb-category-link">
                        <div class="eakb-category-icon">
                            <?php echo $this->render_category_icon($category->slug); ?>
                        </div>
                        ...
                        <span class="eakb-category-count">
                            <?php 
                                    ...
                                    printf(
                                        _n('%s article', '%s articles', $count, 'energy-alabama-kb'),
    ...
    <section class="eakb-recent-articles">
        <div class="eakb-container">
                    ...
                    <a href="<?php echo esc_url($article_link); ?>" class="eakb-article-link">
                        ...
                        <div class="eakb-article-content">
                            ...
                            <div class="eakb-article-meta">
                                ...
                                <?php if ($difficulty) : ?>
                                <span
                                    class="eakb-article-difficulty eakb-difficulty-<?php echo esc_attr($difficulty); ?>">
            ...
            <div class="eakb-view-all">
                <a href="<?php echo esc_url(get_post_type_archive_link('kb_article')); ?>"
                    class="eakb-button eakb-button-secondary">
    ...
    <section class="eakb-quick-links">
        <div class="eakb-container">
            ...
            <div class="eakb-quick-links-grid">
                <a href="<?php echo esc_url(get_term_link(get_term_by('slug', 'legal-regulatory', 'kb_category'))); ?>"
                    class="eakb-quick-link">
                ...
                <a href="<?php echo esc_url(get_term_link(get_term_by('slug', 'educator-resources', 'kb_category'))); ?>"
                    class="eakb-quick-link">
                    <div class="eakb-quick-link-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                            stroke-width="2">
                ...
                <a href="<?php echo esc_url(get_term_link(get_term_by('slug', 'faqs', 'kb_category'))); ?>"
                    class="eakb-quick-link">
                    <div class="eakb-quick-link-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                            stroke-width="2">
